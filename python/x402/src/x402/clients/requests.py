...
class x402HTTPAdapter(HTTPAdapter):
    ...
    def __init__(
        self,
        client: x402Client,
        timeout: Optional[Union[float, Tuple[float, float]]] = 60.0,
        **kwargs,
    ):
        ...
        Args:
            ...
            timeout: Default request timeout in seconds. If the caller explicitly passes a
                timeout per request, that value takes precedence.
    ...
    def send(self, request, **kwargs):
        ...
        Returns:
            Response object
        """
        # requests defaults to timeout=None (wait forever). Enforce a safe default.
...
def x402_http_adapter(
    ...
    **kwargs,
    ...
    return x402HTTPAdapter(client, timeout=timeout, **kwargs)
