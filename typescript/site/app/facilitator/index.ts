...
import { toFacilitatorEvmSigner } from "@aeon-ai-pay/evm";
import { ExactEvmScheme } from "@aeon-ai-pay/evm/exact/facilitator";
import { ExactEvmSchemeV1 } from "@aeon-ai-pay/evm/exact/v1/facilitator";
import { toFacilitatorSvmSigner } from "@aeon-ai-pay/svm";
import { ExactSvmScheme } from "@aeon-ai-pay/svm/exact/facilitator";
import { ExactSvmSchemeV1 } from "@aeon-ai-pay/svm/exact/v1/facilitator";
...
async function createFacilitator(): Promise<x402Facilitator> {
  ...
  const evmSigner = toFacilitatorEvmSigner({
    ...
    estimateGas: (args: { account: `0x${string}`; to: `0x${string}`; data: `0x${string}` }) =>
      viemClient.estimateGas(args as any),
    readContract: (args: {
      address: `0x${string}`;
