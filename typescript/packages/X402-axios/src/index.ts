 ...
 * @param paymentClient - A payment client that can handle EVM transactions
  ...
  axiosClient.interceptors.response.use(
    ...
    async (error: AxiosError) => {
      ...
      try {
        ...
        let namespace: "evm" | undefined;
        if (paymentClient.evmClient) {
          namespace = "evm";
        }
...
export { decodeXPaymentResponse } from "@aeon-ai-pay/x402/shared";
