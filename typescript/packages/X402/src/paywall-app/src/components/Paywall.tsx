...
import { type EnrichedPaymentRequirements } from "@aeon-ai-pay/x402/types";
...
export default function PaymentUI({ paymentRequirements }: PaymentUIProps) {
  ...
  useEffect(() => {
    ...
    console.log("[DEBUG-PAYMENT-FLOW] Selected coin:", selectedCoin);
    console.log("[DEBUG-PAYMENT-FLOW] Compatible methods:", compatibleMethods);
    ...
    console.log("[DEBUG-PAYMENT-FLOW] Matching payment method:", matchingPaymentMethod);
  ...
  const renderPaymentButton = () => {
    ...
    const isValidMethod =
      activePaymentRequirements.namespace === "evm";
