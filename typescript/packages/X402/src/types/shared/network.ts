...
export const EVMNetworkSchema = z.enum([
  "base", "avalanche", "iotex", "bsc", "polygon", "sei", "xlayer"
]);


// Combined network schema
export const NetworkSchema = EVMNetworkSchema;
